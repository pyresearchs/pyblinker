% This script is extracted from extractBlinkProperties.m
function [blinkProps, peaksPosVelZero, peaksPosVelBase] = computeBlinkProperties(blinkFits, signalData, params, srate)
