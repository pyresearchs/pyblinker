...
% -------------------------------------------------------------------------
    ...
    signal= data_signal.blinkComp;
    signalData = struct('signal', signal);
    input_dir_default = fullfile(project_root, 'migration_files');

    % We use the previous output as our input for this
    input_dir_fitblink = fullfile(input_dir_default, 'step1bii_data_output_process_FitBlinks_rpb.mat');
    blinkFits = load(input_dir_fitblink );
    blinkFits=blinkFits.blinkFits;
    ...
    output_file=fullfile(output_dir_default,"step2c_data_output_computeBlinkProperties_rpb.mat");
    ...
    save(output_file, 'blinkProps', '-v7');
    g=1;
    % ---------------------------------------------------------------------
