...
| pyblinker/segmentation/refinement/epochs.py | no | slice_raw_into_mne_epochs_refine_annot | function | public | (raw) | Convert a continuous recording into equally spaced epochs with refinement. | 47 |
