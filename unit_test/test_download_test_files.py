...
import unit_test.data_setup as data_setup
...
class TestAdditionalTestFileDownload(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.required_files = [
            self.test_dir / "blink_properties_fits.pkl",
            self.test_dir / "data_for_selecting_best_channels.pkl",
            self.test_dir / "ear_eog_blink_count_epoch.csv",
        ]
        self.dir_patch = mock.patch.object(
            data_setup, "TEST_FILES_DIR", self.test_dir
        )
