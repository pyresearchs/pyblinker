...
load('Z:\home\rpb\IdeaProjects\EEG-Blinks-Python\plotBlinkFit.mat')
...
% along with this program.  If not, see <http://www.gnu.org/licenses/>.
   ...
   ww=[t(1), t(end)]
    ...
    if leftMin > 0 && leftMin <= length(blinkComponent)
        ee=(blinkFit.leftBase - 1)
        ddd=blinkComponent(leftMin)
        plot(ee./srate, ddd, ...
    ...
    try
        ...
        RR=blinkTraces(1, blinkFit.leftBaseHalfHeight)
        TT=blinkTraces(1, blinkFit.leftBaseHalfHeight)
        line(durationRange, [RR, ...
              TT], ...
